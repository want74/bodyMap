            ...
            <div class="col">
                <div class="row">
                    <div class="priceMore text-white d-flex">
                        <p class="priceNumber mx-auto">8400 RUB</p>
                    </div>
                </div>
                <hr>
                <div class="row">
...
2 по 5 кг <br>2 по 1,25 кг <br>Гриф гантельный, с насечкой. <br>     Вес – 2 кг. <br> Замки резьбовые. <br>Суммарный вес 2-х – 0,5 кг.</p>
                ...
                <div class="row">
                    <div class="btn-group" role="group">
                        <button type="button" class="btn btn-success btn-oneClick">Купить в 1 клик</button>
                        <button type="button" class="btn btn-outline-dark btn-busket">В корзину</button>
                    </div>
                </div>
            </div>
        </div>
